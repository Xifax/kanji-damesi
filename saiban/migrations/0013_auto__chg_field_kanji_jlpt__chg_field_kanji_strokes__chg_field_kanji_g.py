...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kanji.jlpt'
        db.alter_column(u'saiban_kanji', 'jlpt', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Kanji.strokes'
        db.alter_column(u'saiban_kanji', 'strokes', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Kanji.grade'
        db.alter_column(u'saiban_kanji', 'grade', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Kanji.frequency'
        db.alter_column(u'saiban_kanji', 'frequency', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Kanji.jlpt'
        db.alter_column(u'saiban_kanji', 'jlpt', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Kanji.strokes'
        db.alter_column(u'saiban_kanji', 'strokes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Kanji.grade'
        db.alter_column(u'saiban_kanji', 'grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Kanji.frequency'
        db.alter_column(u'saiban_kanji', 'frequency', self.gf('django.db.models.fields.IntegerField')(null=True))
