...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Radical.strokes'
        db.add_column(u'saiban_radical', 'strokes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Radical.position'
        db.add_column(u'saiban_radical', 'position',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Radical.strokes'
        db.delete_column(u'saiban_radical', 'strokes')

        # Deleting field 'Radical.position'
        db.delete_column(u'saiban_radical', 'position')
