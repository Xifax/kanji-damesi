...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compound.pos'
        db.add_column(u'saiban_compound', 'pos',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field antonyms on 'Compound'
        m2m_table_name = db.shorten_name(u'saiban_compound_antonyms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_compound', models.ForeignKey(orm[u'saiban.compound'], null=False)),
            ('to_compound', models.ForeignKey(orm[u'saiban.compound'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_compound_id', 'to_compound_id'])

        # Adding M2M table for field similar on 'Compound'
        m2m_table_name = db.shorten_name(u'saiban_compound_similar')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_compound', models.ForeignKey(orm[u'saiban.compound'], null=False)),
            ('to_compound', models.ForeignKey(orm[u'saiban.compound'], null=False))
    ...
    def backwards(self, orm):
        # Deleting field 'Compound.pos'
        db.delete_column(u'saiban_compound', 'pos')

        # Removing M2M table for field antonyms on 'Compound'
        db.delete_table(db.shorten_name(u'saiban_compound_antonyms'))

        # Removing M2M table for field similar on 'Compound'
        db.delete_table(db.shorten_name(u'saiban_compound_similar'))
    ...
    models = {
        ...
        u'saiban.compound': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pos': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
