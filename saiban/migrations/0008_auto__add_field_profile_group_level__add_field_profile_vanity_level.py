...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.group_level'
        db.add_column(u'saiban_profile', 'group_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Profile.vanity_level'
        db.add_column(u'saiban_profile', 'vanity_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.group_level'
        db.delete_column(u'saiban_profile', 'group_level')

        # Deleting field 'Profile.vanity_level'
        db.delete_column(u'saiban_profile', 'vanity_level')
