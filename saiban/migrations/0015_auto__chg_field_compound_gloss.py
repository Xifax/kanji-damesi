...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compound.gloss'
        db.alter_column(u'saiban_compound', 'gloss', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

    def backwards(self, orm):

        # Changing field 'Compound.gloss'
        db.alter_column(u'saiban_compound', 'gloss', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
