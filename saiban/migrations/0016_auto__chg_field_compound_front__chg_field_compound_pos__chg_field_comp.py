...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compound.front'
        db.alter_column(u'saiban_compound', 'front', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Changing field 'Compound.pos'
        db.alter_column(u'saiban_compound', 'pos', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Compound.reading'
        db.alter_column(u'saiban_compound', 'reading', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Compound.front'
        db.alter_column(u'saiban_compound', 'front', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))

        # Changing field 'Compound.pos'
        db.alter_column(u'saiban_compound', 'pos', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Compound.reading'
        db.alter_column(u'saiban_compound', 'reading', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
